...
export const BottomNav: React.FC<BottomNavProps> = ({ currentScreen, onNavigate, cartItemCount }) => {
  ...
  return (
    <div className="absolute bottom-6 left-0 right-0 flex items-center justify-center gap-3 px-5 z-[90]">
      <motion.div 
        ...
        className="flex-1 flex bg-[#f8f9fa]/80 backdrop-blur-2xl border border-white/60 shadow-[0_8px_32px_rgb(0,0,0,0.08)] rounded-full p-1 items-center relative touch-none"
      >
        {TABS.map((tab) => {
