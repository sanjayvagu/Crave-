    ...
    >
      <AnimatePresence>
        {toast && (
          ...
          >
            <div className="bg-slate-900  text-white  px-6 py-4 rounded-2xl shadow-2xl flex flex-col items-center text-center max-w-sm w-full mx-8">
      ...
      <div className="absolute top-0 right-0 p-4 z-50 pt-[max(1.5rem,env(safe-area-inset-top))] flex gap-3">
        <motion.button
          ...
          className="bg-white/80  backdrop-blur-md p-3 rounded-full shadow-lg border border-slate-200  text-slate-700  flex items-center justify-center gap-2"
        >
      ...
      <div className="h-2/5 w-full bg-[#f0f2f5]  relative overflow-hidden">
        {/* Grid Background */}
        <div
        ...
        <div className="absolute inset-0 pointer-events-none">
          <svg
            className="w-full h-full text-blue-500/60  drop-shadow-md"
            viewBox="0 0 100 100"
          ...
          {currentStep >= 1 && (
            ...
            >
              <div className="relative">
                ...
                <div className="w-10 h-10 bg-slate-900  text-white  rounded-full shadow-2xl flex items-center justify-center relative z-10">
        ...
        <motion.button
          whileTap={{ scale: 0.9 }}
          onClick={onGoHome}
          className="absolute left-5 w-10 h-10 rounded-full bg-white/80  backdrop-blur-md flex items-center justify-center text-slate-700  shadow-sm z-30"
      ...
      <div className="flex-1 bg-white  rounded-t-3xl -mt-6 relative z-20 shadow-[0_-10px_40px_rgb(0,0,0,0.08)] p-6 flex flex-col">
            ...
            {STATUSES.map((status, index) => {
              ...
              return (
                ...
                >
                  ...
                  <p
                    className={`text-[10px] font-bold text-center w-16 leading-tight transition-colors duration-300 ${isCurrent ? "text-slate-800 " : isCompleted ? "text-slate-600 " : "text-slate-400 "}`}
                  >
                    {status.label}
                  </p>
                </div>
        ...
        <motion.div
          layout
          className="bg-slate-50  rounded-2xl p-5 border border-slate-100  flex-1 relative overflow-hidden"
        >
        ...
        {showChat && (
          ...
          >
            <motion.div
              ...
              exit={{ y: "100%" }}
              transition={{ type: "spring", stiffness: 300, damping: 30 }}
              className="bg-slate-50  w-full h-[80%] rounded-t-3xl shadow-2xl flex flex-col relative overflow-hidden"
            >
              {/* Header */}
              <div className="bg-white  p-4 border-b border-slate-200  flex items-center justify-between shrink-0">
                ...
                <button
                  ...
                  className="p-2 text-slate-400  hover:bg-slate-100 :bg-slate-800 rounded-full"
                >
                  <X className="w-5 h-5" />
                </button>
              </div>
