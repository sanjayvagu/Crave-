...
import { ArrowLeft, User, CreditCard, MapPin, Bell, LogOut, ChevronRight, Plus, MapPin as MapPinIcon, Check, Wallet, Smartphone, Landmark } from 'lucide-react';
        ...
        {activeView === 'main' && (
          ...
          >
            <div className="flex items-center gap-4 p-5 bg-white shadow-sm z-10 shrink-0 border-b border-slate-100">
              ...
              <h1 className="font-bold text-lg text-slate-800 tracking-tight">Profile</h1>
            </div>
            ...
            <div className="flex-1 overflow-y-auto no-scrollbar pb-32">
              <div className="bg-white p-6 shadow-sm border-b border-slate-100 flex flex-col items-center mb-4">
                ...
                <p className="text-slate-500 font-medium mt-1">jane.doe@example.com</p>
                <p className="text-slate-500 font-medium mt-0.5">+1 (555) 123-4567</p>
              </div>
          ...
          >
            <div className="flex items-center justify-between p-5 bg-white shadow-sm z-10 shrink-0 border-b border-slate-100">
              <div className="flex items-center gap-4">
                ...
                <h1 className="font-bold text-lg text-slate-800 tracking-tight">Edit Profile</h1>
              </div>
            </div>
            <div className="flex-1 overflow-y-auto p-5 pb-32">
              ...
              <div className="space-y-4">
                <div>
                  <label className="text-xs font-bold text-slate-500 uppercase tracking-widest ml-1 mb-1.5 block">Full Name</label>
                  <input type="text" defaultValue="Jane Doe" className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3.5 font-bold text-slate-800 outline-none focus:border-[#fc8019] transition-colors" />
                </div>
                <div>
                  <label className="text-xs font-bold text-slate-500 uppercase tracking-widest ml-1 mb-1.5 block">Email Address</label>
                  <input type="email" defaultValue="jane.doe@example.com" className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3.5 font-bold text-slate-800 outline-none focus:border-[#fc8019] transition-colors" />
                </div>
                <div>
                  <label className="text-xs font-bold text-slate-500 uppercase tracking-widest ml-1 mb-1.5 block">Phone Number</label>
                  <input type="tel" defaultValue="+1 (555) 123-4567" className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3.5 font-bold text-slate-800 outline-none focus:border-[#fc8019] transition-colors" />
                </div>
              </div>
            </div>
          ...
          >
            <div className="flex items-center justify-between p-5 bg-white shadow-sm z-10 shrink-0 border-b border-slate-100">
              <div className="flex items-center gap-4">
                ...
                <h1 className="font-bold text-lg text-slate-800 tracking-tight">Saved Addresses</h1>
              </div>
            </div>
            <div className="flex-1 overflow-y-auto p-5 pb-32 space-y-4">
              <div className="bg-white rounded-2xl p-4 border border-slate-200 shadow-sm relative overflow-hidden group">
                ...
                <div className="flex gap-4">
                   ...
                   <div>
                     <h3 className="font-bold text-slate-800 text-base mb-1">Home</h3>
                     <p className="text-sm text-slate-500 leading-snug">123 Design Avenue, Tech Park Building A, Floor 5, NY 10001</p>
                   </div>
                </div>
                <div className="mt-4 pt-4 border-t border-slate-100 flex gap-4">
                   <button className="text-sm font-bold text-[#fc8019]">Edit</button>
                   <button className="text-sm font-bold text-slate-400">Delete</button>
                </div>
              </div>
              ...
              <div className="bg-white rounded-2xl p-4 border border-slate-100 shadow-sm relative overflow-hidden group">
                <div className="flex gap-4">
                   ...
                   <div>
                     <h3 className="font-bold text-slate-800 text-base mb-1">Office</h3>
                     <p className="text-sm text-slate-500 leading-snug">456 Corporate Towers, Block C, NY 10002</p>
                   </div>
                </div>
                <div className="mt-4 pt-4 border-t border-slate-100 flex gap-4">
                   <button className="text-sm font-bold text-[#fc8019]">Edit</button>
          ...
          >
            <div className="flex items-center justify-between p-5 bg-white shadow-sm z-10 shrink-0 border-b border-slate-100">
              <div className="flex items-center gap-4">
                ...
                <h1 className="font-bold text-lg text-slate-800 tracking-tight">Payment Methods</h1>
              </div>
            </div>
            <div className="flex-1 overflow-y-auto p-5 pb-32 space-y-6">
              
              <div>
                 <h2 className="text-xs font-bold text-slate-500 uppercase tracking-widest ml-1 mb-3">Saved Cards</h2>
                 <div className="bg-white rounded-2xl p-4 border border-slate-200 shadow-sm relative overflow-hidden mb-3 group">
                   ...
                   <div className="flex gap-4 items-center">
                      ...
                      <div>
                        <h3 className="font-bold text-slate-800 text-base mb-0.5">•••• •••• •••• 4242</h3>
                 ...
                 <div className="bg-white rounded-2xl p-4 border border-slate-100 shadow-sm relative overflow-hidden mb-4 group">
                   <div className="flex gap-4 items-center">
                      ...
                      <div>
                        <h3 className="font-bold text-slate-800 text-base mb-0.5">•••• •••• •••• 8899</h3>
                        <p className="text-sm text-slate-500">Expires 08/24</p>
                      </div>
                   </div>
                 </div>
              ...
              <div>
                 <h2 className="text-xs font-bold text-slate-500 uppercase tracking-widest ml-1 mb-3">Other Methods</h2>
                 <div className="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
                   ...
                   <div className="p-4 border-b border-slate-100 flex items-center gap-4 cursor-pointer hover:bg-slate-50 transition-colors">
                      ...
                      <span className="font-bold text-slate-800">UPI Apps</span>
                   </div>
                   <div className="p-4 flex items-center gap-4 cursor-pointer hover:bg-slate-50 transition-colors">
                      ...
                      <span className="font-bold text-slate-800">Store Wallet ($45.50)</span>
                   </div>
                 </div>
              </div>
            </div>
