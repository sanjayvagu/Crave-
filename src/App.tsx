...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-900 flex items-center justify-center p-0 sm:p-8 font-sans">
      {/* Simulated Mobile Device Frame */}
      <div className="w-full h-[100dvh] sm:h-[844px] sm:w-[390px] bg-slate-50 relative overflow-hidden sm:rounded-[40px] shadow-2xl sm:border-[8px] sm:border-slate-800 flex flex-col">
